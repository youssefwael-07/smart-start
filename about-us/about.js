...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        if (heroDescription) heroDescription.style.animation = 'slideInUp 0.8s ease forwards';
    }, 400);
    
    setTimeout(() => {
        if (heroButtons) heroButtons.style.animation = 'slideInUp 0.8s ease forwards';
    }, 600);
});
